...
comment on function public.merge_guild_defense_library_roots(uuid, uuid, uuid, uuid, text, jsonb)
  is 'Fusionne deux roots Bibliotheque equivalentes. V2 preserve la presence locale de la guilde absorbed en convertissant sa root active en copie locale lorsque necessaire.';
