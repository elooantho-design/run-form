                    ...
                    visibleJobs.map((job) => (
                      ...
                      >
                        ...
                        <button
                          ...
                          disabled={deletingJobId === getJobId(job) || isJobDeletionLocked(job)}
                          onClick={(event) => {
                            event.stopPropagation();
                            deleteServerJob(job);
                          }}
                          title={isJobDeletionLocked(job) ? `${getJobLockLabel(job)}. Supprimable apres reset.` : "Supprimer ce probe du serveur"}
                        >
